...
RESOURCES += src/qt/bitradio.qrc src/qt/bitradio_locale.qrc

TRANSLATIONS += src/qt/locale/bitradio_bg.ts \
                src/qt/locale/bitradio_de.ts \
                src/qt/locale/bitradio_en.ts \
                src/qt/locale/bitradio_es.ts \
                src/qt/locale/bitradio_fi.ts \
                src/qt/locale/bitradio_fr.ts \
                src/qt/locale/bitradio_it.ts \
                src/qt/locale/bitradio_ja.ts \
                src/qt/locale/bitradio_pl.ts \
                src/qt/locale/bitradio_pt.ts \
                src/qt/locale/bitradio_ru.ts \
                src/qt/locale/bitradio_sk.ts \
                src/qt/locale/bitradio_sv.ts \
                src/qt/locale/bitradio_vi.ts \
                src/qt/locale/bitradio_zh_CN.ts \
                src/qt/locale/bitradio_zh_TW.ts
