...
# Copyright (c) 2020 The Bitradio Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitradio repository."
  exit 1
fi
...
echo 'When compiling bitradiod, run `./configure` in the following way:'
echo
