...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BitRadio server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BitRadio server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitRadio features */
        {"bitradio", "masternode", &masternode, true, true, false},
        {"bitradio", "listmasternodes", &listmasternodes, true, true, false},
        {"bitradio", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitradio", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitradio", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitradio", "masternodedebug", &masternodedebug, true, true, false},
        {"bitradio", "startmasternode", &startmasternode, true, true, false},
        {"bitradio", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitradio", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitradio", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitradio", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitradio", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitradio", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitradio", "mnbudget", &mnbudget, true, true, false},
        {"bitradio", "preparebudget", &preparebudget, true, true, false},
        {"bitradio", "submitbudget", &submitbudget, true, true, false},
        {"bitradio", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitradio", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitradio", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitradio", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitradio", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitradio", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitradio", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitradio", "checkbudgets", &checkbudgets, true, true, false},
        {"bitradio", "mnsync", &mnsync, true, true, false},
        {"bitradio", "spork", &spork, true, true, false},
        {"bitradio", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitradio", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitradiod, or the -server option to bitradio-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitradio-cli " + methodname + " " + args + "\n";
}
