...
/** Utility functions used by the BitRadio Qt UI.
 */
namespace GUIUtil
{
...
// Render BitRadio addresses in monospace font
...
// Parse "BitRadio:" URI into recipient object, return true on successful parsing
