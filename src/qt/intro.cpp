...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitRadio Core"),
     ...
     * override -datadir in the BitRadio.conf file in the default data directory
     * (to be consistent with BitRadiod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
