                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitRadio Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BRO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitradio: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitRadio Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitRadio Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitRadio"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BRO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BRO addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitradio: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitRadio Core help message to get a list with possible BitRadio command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitRadio Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BitRadio Core"); // default title
