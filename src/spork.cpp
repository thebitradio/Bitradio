...
bool IsSporkActive(int nSporkID)
{
	...
	if (nSporkID == SPORK_18_FAKE_STAKE_FIX) r = SPORK_18_FAKE_STAKE_FIX_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_18_FAKE_STAKE_FIX") return SPORK_18_FAKE_STAKE_FIX;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_18_FAKE_STAKE_FIX) return "SPORK_18_FAKE_STAKE_FIX";
