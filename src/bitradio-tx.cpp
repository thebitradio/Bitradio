...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitRadio Core bitradio-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitradio-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BitRadio transaction") + "\n" +
                               "  bitradio-tx [options] -create [commands]   " + _("Create hex-encoded BitRadio transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BitRadio transaction
