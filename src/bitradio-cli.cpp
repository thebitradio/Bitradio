...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("BitRadio Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  bitradio-cli [options] <command> [params]  " + _("Send command to BitRadio Core") + "\n" +
                        "  bitradio-cli [options] help                " + _("List commands") + "\n" +
                        "  bitradio-cli [options] help <command>      " + _("Get help for a command") + "\n";
