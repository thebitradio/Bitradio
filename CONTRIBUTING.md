Contributing to BitRadio Core
============================

The BitRadio Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitRadio Core project, and is not to be
confused with overall BitRadio Network Protocol consensus changes.

Whether a pull request is merged into BitRadio Core rests with the project merge
...
Patches that change BitRadio consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitRadio consensus, it must have been
...
The project leader is the release manager for each BitRadio Core release.
